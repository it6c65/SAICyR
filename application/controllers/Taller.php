...
class Taller extends CI_Controller {
    ...
    public function index(){
        $this->load->database();
        $data = array( "title" => "Taller", "header" => "Taller de Restauración", "user" => $this->session->userdata("name"), "admin" => $this->session->userdata("segurity"), "area" => $this->session->userdata("zone"), "current" => 1 );
